...
export default function GlobalErrorPage({ reset }: { error: Error & { digest?: string }; reset: () => void }) {
  return (
    <html lang="ar" dir="rtl">
      <body className="min-h-screen flex items-center justify-center px-4 bg-[#fdf2f8]">
        <div className="text-center max-w-lg">
          ...
          <h1 className="text-3xl md:text-4xl font-bold text-gray-800 mb-3">خطأ في التطبيق</h1>
          <p className="text-gray-500 mb-8 leading-relaxed">
            نعتذر، حدث خطأ فني في التطبيق. فريقنا يعمل على إصلاحه. يمكنك المحاولة مرة أخرى أو العودة للصفحة الرئيسية.
          </p>
